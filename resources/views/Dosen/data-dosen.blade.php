                      ...
                      @foreach ($Dosen as $item )
                        <tbody>
                          <td>{{ $item->namadosen }}
                            ...
                            <div>
                              <a href="{{ url('edit-dosen',$item->id) }}"><i class="ri-edit-box-line"></i></a>
      
                              <a href="{{ url('delete-dosen',$item->id) }}"onclick="return confirm('Are you sure you want to delete this item?');"><i class="ri-delete-bin-line" style="color: red"></i></a>
      
                              <a href="{{ url('detail-dosen',$item->id) }}"><i class="ri-more-fill" style="color: black"></i></a>
                            </div>
                          </td>
