  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <section id="hero" class="d-flex align-items-center justify-content-center">
      <div class="card" data-aos="fade-up">
        <form action="{{ route('simpan-surat') }}" method="POST">
          {{ csrf_field() }}
          <div class="card-body row">
            <div class="col-12 text-center d-flex align-items-center justify-content-center">
              <div class="">
                <p class="lead mb-8"><strong>INPUT SURAT</strong></p>
              </div>
            </div>
          
              <div class="form-group" style="margin: 4px">
                <label for="nama_surat">Nama Surat</label>
                <input type="text" id="nama_surat" name="nama_surat" class="form-control" placeholder="Masukkan nama surat">
              </div>
              <div class="form-group" style="margin: 4px">
                <label for="subkriteria">Min Nilai</label>
                <input type="number" id="elementThree" name="min_nilai" class="form-control"  placeholder="Masukan Minimal Nilai" >
              </div>
              <div class="form-group" style="margin: 4px">
                <label for="subkriteria">Maks. Nilai</label>
                <input type="text"  id="elementFour" name="maks_nilai" class="form-control" placeholder="Masukan Maksimal nilai">
              </div>

              <div class="form-group" style="margin: 4px">
                <label for="subkriteria">Isi surat</label>
                <textarea class="form-control" name="isi_surat" required></textarea>
              </div>
              <div>
